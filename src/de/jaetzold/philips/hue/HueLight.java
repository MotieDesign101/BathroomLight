...
public interface HueLight {
	 ...
	 * For a {@link de.jaetzold.philips.hue.HueVirtualLightGroup} this name is not stored on the device and may be of any length.
	 *
	 ...
	 * for further reference.</p>
	 *
	 * @param effect the effect. May not be null, use {@link de.jaetzold.philips.hue.HueLight.Effect#NONE} if no effect should be set.
	 */
	 ...
	 * for further reference.</p>
	 *
	 * @param alert the alert. May not be null, use {@link de.jaetzold.philips.hue.HueLight.Alert#NONE} if no alert should be set.
	 */
