 ...
 * So effectively only the implicit group 0 containing all the lights can be used. But see {@link de.jaetzold.philips.hue.HueVirtualLightGroup} for a way around that.
 *
