 ...
 * </p>
 * <p>
 *     Any problem communicating with the bridge device will result in a {@link de.jaetzold.philips.hue.HueCommException} to be thrown which carries
 *     the error json with more information.
 * </p>
 *
 * @see de.jaetzold.philips.hue.HueLightBulb
 * @see de.jaetzold.philips.hue.HueLightGroup
 * @see de.jaetzold.philips.hue.HueVirtualLightGroup
 *
...
public class HueBridge {
	 ...
	 *
	 * @return A {@link de.jaetzold.philips.hue.HueLightBulb} with the given id or null if none with that id is known.
	 */
	 ...
	 *
	 * @return A {@link de.jaetzold.philips.hue.HueLightGroup} with the given id or null if none with that id exists.
	 */
	...
	/**
	 * Provide a collection of all {@link de.jaetzold.philips.hue.HueVirtualLightGroup} instances that are currently defined on this bridge API instance.
	 *
	 * @see de.jaetzold.philips.hue.HueVirtualLightGroup
	 ...
	 *
	 * @return A {@link de.jaetzold.philips.hue.HueVirtualLightGroup} with the given id or null if none with that id is defined on this bridge API instance.
	 */
	@SuppressWarnings("UnusedDeclaration")
